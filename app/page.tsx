  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-24 pb-12">
        ...
        {/* TOP CENTER PURE FLOATING COUNTDOWN TIMER (NO BACKGROUND CARD/PADDING) */}
        <div className="absolute top-6 sm:top-10 left-1/2 -translate-x-1/2 z-20 countdown-floating hover-pop">
          <div className="flex items-center gap-4 sm:gap-7 text-slate-900 font-extrabold select-none">
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-5xl text-[#2563EB] font-black tracking-tight drop-shadow-sm">
                {String(timeLeft.days).padStart(2, '0')}
              </span>
              <span className="text-[10px] sm:text-xs uppercase font-extrabold text-[#334155] tracking-widest pt-1">Days</span>
            </div>
            <span className="text-2xl sm:text-4xl text-[#2563EB]/60 font-light -mt-4">:</span>

            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-5xl text-[#2563EB] font-black tracking-tight drop-shadow-sm">
                {String(timeLeft.hours).padStart(2, '0')}
              </span>
              <span className="text-[10px] sm:text-xs uppercase font-extrabold text-[#334155] tracking-widest pt-1">Hours</span>
            </div>
            <span className="text-2xl sm:text-4xl text-[#2563EB]/60 font-light -mt-4">:</span>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[10px] sm:text-xs uppercase font-extrabold text-[#334155] tracking-widest pt-1">Mins</span>
            </div>
            <span className="text-2xl sm:text-4xl text-[#2563EB]/60 font-light -mt-4">:</span>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[10px] sm:text-xs uppercase font-extrabold text-[#334155] tracking-widest pt-1">Secs</span>
            </div>
          </div>
        </div>

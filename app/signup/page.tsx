...
export default function SignupPage() {
  ...
  return (
    <div className="pt-28 pb-20 bg-[#0B0F17] text-slate-200 min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute w-[500px] h-[500px] bg-[#2563EB]/10 rounded-full blur-[140px] pointer-events-none -top-20 -right-20" />
      <div className="absolute w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[120px] pointer-events-none -bottom-20 -left-20" />
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-2xl backdrop-blur-xl space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xs text-slate-400 max-w-xs mx-auto">
              Join AWIE to shop <span className="text-[#2563EB] font-bold">AWIE Store</span> catalog, order hardware & access customer dashboard
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 p-1 rounded-xl bg-slate-950 border border-slate-800 text-xs font-bold">
            <Link href="/login" className="py-2.5 rounded-lg text-slate-400 hover:text-white text-center transition-colors">
              Sign In
            </Link>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-1">
              <input
                ...
                className="w-4 h-4 rounded bg-slate-950 border-slate-800 text-[#2563EB] focus:ring-[#2563EB]"
              />
              <label htmlFor="agree" className="text-[11px] text-slate-400 font-medium select-none">
                I agree to the <Link href="/store-terms" className="text-[#2563EB] hover:underline">Terms of Service</Link> & <Link href="/privacy" className="text-[#2563EB] hover:underline">Privacy Policy</Link>
              </label>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[#2563EB] hover:bg-blue-600 disabled:opacity-50 text-white font-bold text-xs transition-all shadow-lg shadow-[#2563EB]/25 flex items-center justify-center gap-2"
            >
